...
int calculate_texture_x(float ray_x, float ray_y, int direction, t_texture *texture)
{
    int	tex_x;
...
void draw_texture_column(t_execution *execution, int column, t_texture *texture, int tex_x)
{
    int	y;
    int	tex_y;
    int	color;
...
void draw_textured_wall(t_execution *execution, int column, int direction)
{
    ...
    {
        draw_solid_color_wall(execution, column, execution->wall_start, 
                              execution->wall_end, direction);
        return;
    }
